...
Full docs on the wiki: [Testing Harness](https://github.com/ringavirda/exlib/wiki/Testing-Harness),
[Testing API Reference](https://github.com/ringavirda/exlib/wiki/Testing-API-Reference).
