...
public class WidgetTests {
  private static (TestWorld world, BlockEntityWidget be) PlaceWidget() {
    var world = new TestWorld();
    var pos = new BlockPos(0, 0, 0);
    Block block = TestBlocks.Configure(
      new BlockWidget(),
      "widgetdomain:widget-north",
      1
    );
  ...
  public void Counts_a_tick_and_round_trips_through_the_tree() {
    (TestWorld world, BlockEntityWidget be) = PlaceWidget();
    ...
    var restored = new BlockEntityWidget { Pos = be.Pos, Block = be.Block };
