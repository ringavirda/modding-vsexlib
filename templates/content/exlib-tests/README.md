...
wiki's [Testing Harness](https://github.com/ringavirda/modding-vsexlib/wiki/Testing-Harness).

```
dotnet new install ./templates/content/exlib-tests
...
Uninstall with `dotnet new uninstall ./templates/content/exlib-tests` (or by identity,
