...
/// <summary>Holds the recipe-cost level, separately from the catalogue that manages it.</summary>
[ExConfigRegister(
...
/// <summary>The catalogue half of the split; <see cref="ExRecipeProfileAttribute.LevelConfig"/>
/// points at <see cref="ExRecipeProfileCrossClassLevelTestConfig"/> for <c>RecipeLevel</c>.</summary>
[ExConfigRegister(
