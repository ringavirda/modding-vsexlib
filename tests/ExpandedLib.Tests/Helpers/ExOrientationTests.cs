...
/// <summary>
/// The horizontal rotation math used to place fillers, connectors and particle boxes on oriented
/// blocks: north 0, west 90, south 180, east 270, with the offset convention
...
public class ExOrientationTests {
  ...
  /// <summary>Checks the continuous overload turns the same as the integer one.</summary>
  [Theory]
  [InlineData(0)]
  [InlineData(90)]
  [InlineData(180)]
  ...
  /// <summary>UnrotateXZ inverts RotateXZ at every angle.</summary>
  [Theory]
  [InlineData(0)]
  [InlineData(90)]
  [InlineData(180)]
  ...
  /// <summary>UnrotateXZ is a real turn, not an identity.</summary>
  [Theory]
  [InlineData(0, 2d)]
  [InlineData(90, -3d)]
  [InlineData(180, -2d)]
