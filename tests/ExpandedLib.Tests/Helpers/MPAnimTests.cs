...
/// <summary>The phase-lock math (<see cref="MPAnim.AdvanceFrame"/>) that keeps a driven part in
/// step with a mechanical-power axle's angle.</summary>
public class MPAnimTests {
  ...
  public void A_quarter_turn_advances_a_quarter_of_the_cycle() {
    // 40-frame cycle, axle turns 90 deg (a quarter of 2pi) -> a quarter of 40 frames.
  ...
  public void A_full_revolution_returns_to_the_same_frame() {
    ...
    // Just shy of a full turn; the frame stays just shy of wrapping to 0.
  ...
  public void A_full_turn_maps_onto_the_whole_frame_space() {
    // The span is the full frame count [0, QuantityFrames), not the last keyframe's index.
  ...
  public void A_reversed_axle_runs_the_cycle_backwards() {
    // Direction comes from the angle's sign; the caller passes the axle's render angle directly.
