...
public class BlockEntitySmokeStack
  ...
  protected override string GetIncompleteMessage(int missingCount) =>
    Lang.Get("smokestack:structure-incomplete-count", missingCount);

  protected override string GetCompleteMessage() =>
    Lang.Get("smokestack:smokestack-complete");
  ...
  public override void GetBlockInfo(IPlayer forPlayer, StringBuilder dsc) {
    if (!StructureComplete) {
      dsc.AppendLine(Lang.Get("smokestack:structure-incomplete"));
      return;
    }
    dsc.AppendLine(
      Lang.Get(
        "smokestack:smokestack-info-consuming",
