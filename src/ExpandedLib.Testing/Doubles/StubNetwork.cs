...
/// <summary>Medium-less concrete <see cref="BlockNetwork"/> for exercising the graph engine
/// (<see cref="BlockNetworkModSystem"/>) in isolation, with no pipe or molten state semantics.
/// <see cref="Tag"/> is carried through merge, split and inherit.</summary>
