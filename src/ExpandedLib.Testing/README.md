...
Full docs on the wiki: [Testing Harness](https://github.com/ringavirda/modding-vsexlib/wiki/Testing-Harness),
[Testing API Reference](https://github.com/ringavirda/modding-vsexlib/wiki/Testing-API-Reference).
