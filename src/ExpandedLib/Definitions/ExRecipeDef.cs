...
/// <summary>
/// Code-first recipe file, producing one <c>recipes/{category}/{assetName}.json</c> synthetic asset.
/// Either an array of recipes or a single recipe object; mixing the two modes throws.
/// </summary>
public sealed class ExRecipeDef : IExDef {
  ...
  /// <summary>Appends one grid recipe (array mode) authored via <see cref="GridRecipeBuilder"/>.</summary>
  ...
  /// <summary>Appends an arbitrary recipe object (array mode).</summary>
  ...
  /// <summary>Sets the file to a single recipe object from a POCO, anonymous object, or token.</summary>
  ...
  /// <summary>The built recipe-file JSON the loader reads: the array, or the single object, defensively cloned.</summary>
