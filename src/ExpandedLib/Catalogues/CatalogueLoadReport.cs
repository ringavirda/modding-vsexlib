...
/// <summary>One catalogue's load outcome: files read, entries accepted, and the errors, each
/// naming its asset.</summary>
...
/// <param name="Errors">One human-readable message per malformed file or clash.</param>
public sealed record CatalogueLoadReport(
  ...
  /// <summary>Writes one Notification line summarising the load, then one Error line per entry of
